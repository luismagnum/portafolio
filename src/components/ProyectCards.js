...
import zully from '../assets/images/images/zullynew.png';
...
export default function ProyectCards() {
  const projects = [
    ...
    { img: zully, title: "Landing Page", desc: "Landing page Psicologa clinica...", git: "https://github.com/luismagnum/zullydiaz", deploy: "https://www.zullydiaz.com" },
